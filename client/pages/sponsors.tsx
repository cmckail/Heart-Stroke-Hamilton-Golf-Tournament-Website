...
const companyName = [
  {
    name: "Gator Ted's",
    description:
      "The Kindos Family that owns this iconic Burlington Sports Pub, has also been a loyal friend of the Segin Family, and supporter of our event since the beginning. Gator ‘Ted’, Sisters Mary Anne and Michelle, and of course ‘Ma’ Kindos are an amazing & charitable family that we are proud to call friends.",
  ...
  },
  {
    name: "Routes",
    description:
      "Routes Transport has been associated with our tournament since its inception in 2014. Virgil Macera, President of Routes, feels that ‘Giving Is Vital For Happiness’ And his support as Cart Sponsor each year helps push us toward our target goals.",
  ...
  },
  {
    ...
    description:
      "Waterloo Brewery is our Beer Partner for our 2021 Golf Tournament. We are honoured to have them provide our golfers with a wonderful Thank You gift from Land Shark Beer.",
  ...
  },
  {
    ...
    description:
      "Owner Mike Marcolin and his staff at QB’s has been a mainstay supporter to our event from the beginning. QB’s is a Burlington Institution when it comes to Sports Bars in the Halton area. It’s massive dining room, games room and too many TV’s to count, make it a perfect place for families, sports teams and kids to enjoy an evening out. ",
  ...
  },
  {
    ...
    description:
      "Fox40 is famous for the ‘pealess whistle’ that is used in the NBA, NHL, NFL, CFL and all over the world where officiating is required. BUt they have also been a major supporter of our event each year through the generosity of Dave Foxcroft, President at Fox40. His donations and support raise a great portion each & every year. We are lucky to have a great corporate partner like the Foxcroft Family.",
    ...
    <div>
      ...
      {sponsors && (
        <div className="sponsorsContainer">
          ...
          <p>
            {" "}
            We wish to thank our loyal Corporate Supporters That make our event
            possible each and every year. We invite you to take a peek at their
            websites and encourage you to support their business. You will not
            be disappointed.{" "}
          </p>
          <Box display="flex" flexWrap="wrap" justifyContent="center">
            ...
            {companyName.map((sponsor, index) => {
              return (
                // <Grid item xs={3} key={index} style={{ margin: "10px" }}>
                <Card
                  key={index}
