    ...
    <div className={classes.root}>
      ...
      <div className={classes.jumbotron}>
        <h2
          ...
          style={{
            fontSize:
              windowWidth > 1500 ? "60px" : windowWidth > 1000 ? "4vw" : "4vh",
          }}
        >
        ...
        <p
          ...
          style={{
            fontSize:
              windowWidth > 1500 ? "30px" : windowWidth > 1000 ? "2vw" : "2vh",
          }}
        >
      ...
      <Grid container spacing={4} style={{ width: "100%", margin: "1em auto" }}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Link href="/registration">
            <div className={[classes.card, classes.gridContent].join(" ")}>
              ...
              <p>
                To keep you safe, tee off is socially distanced in groups of up
                to 4 players. Tee time is selected during registration.
              </p>
            </div>
          </Link>
        </Grid>
